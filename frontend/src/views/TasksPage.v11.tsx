    ...
    return (
      <li key={task.id} style={{ marginBottom: 4 }}>
        ...
        >
          ...
          />
          <span>
            {task.titolo} ({task.priorita}){' '}
            {task.luogo ? `- ${task.luogo}` : ''}
          </span>
          <button
            style={{ fontSize: 12 }}
            onClick={() => {
