...
interface NewEventModalProps {
  ...
  onEventSaved: () => void; 
  initialDate?: string | null; // <--- AGGIUNTO: Permette di ricevere la data
}
  ...
  useEffect(() => {
    if (isOpen) {
      if (eventToEdit) {
        ...
        // AGGIUNTO: Se ci mandano initialDate, usiamo quella!
        setNewEventForm({
          titolo: '', 
          descrizione: '', 
        ...
        // Sincronizziamo anche il calendario a tendina con la data passata
        if (initialDate) {
